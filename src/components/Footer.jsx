      ...
      <div className="container">
        ...
        <div className={styles.top}>
          ...
          <div className={styles.brand}>
            <a href="/" className={styles.logo}>
              <span className={styles.logoMain}>Casa</span>
              <span className={styles.logoAccent}>Forma</span>
            </a>
        ...
        <div className={styles.bottom}>
          <span className={styles.copy}>
            © {new Date().getFullYear()} Casa Forma S.r.l. — P.IVA 01234567890 — Bologna
          </span>
          <div className={styles.legal}>
            <a href="#" className={styles.legalLink}>{t('footer_privacy')}</a>
            <a href="#" className={styles.legalLink}>{t('footer_cookie')}</a>
            <a href="#" className={styles.legalLink}>{t('footer_terms')}</a>
          </div>
        </div>
