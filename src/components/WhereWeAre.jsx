      ...
      <div className={styles.layout}>
        ...
        <div className={styles.info}>
          ...
          <div className={styles.addressBlock}>
            ...
            <div>
              ...
              <p className={styles.city}>70024 Gravina in Puglia (BA)</p>
            </div>
          </div>
          ...
          <div className={styles.contactRow}>
            ...
            <a href="tel:+390511234567" className={styles.contactLink}>
              +39 051 123 4567
            </a>
          </div>
          ...
          <div className={styles.contactRow}>
            ...
            <a
              href="mailto:info@arredareambient.it"
              className={styles.contactLink}
            >
              info@arredareambient.it
            </a>
          </div>
        ...
        <div className={styles.mapWrap}>
          ...
          <div className={styles.mapPin}>
            ...
            <span>Showroom · Gravina in Puglia</span>
          </div>
        </div>
      </div>
    </section>
